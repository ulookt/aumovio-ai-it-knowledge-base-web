...
or (unzip the zipped file if you have downloaded that way)
...
4. Open the applicationOpen a browser and navigate to: http://localhost:5202 (or the localhost which pops up in your terminal)
